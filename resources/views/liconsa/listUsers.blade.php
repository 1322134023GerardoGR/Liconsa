...
<header class="header">
    ...
    <img class="logo-mexico" src="{{ asset('img/logo_gobierno_mexico.png') }}" alt="Logo del Gobierno de México">
</header>
...
<div class="content">
    ...
    <div class="side-menu" id="sideMenu">
        ...
        <div class="submenu" id="personalizacionDropdown">
            <div class="menu-option" onclick="toggleModoOscuro()">
                <i class="bi bi-moon"></i> Modo Oscuro
            </div>
            <div class="menu-option" onclick="toggleDaltonismoMenu()">
                <i class="bi bi-eye"></i> Modo Daltónico
            </div>
...
<script>
    ...
    function handleHover(event) {
        ...
        let text = event.target.innerText || event.target.alt || event.target.getAttribute("aria-label");
        speakText(text);
    }
    ...
    document.getElementById("toggleReadingGuide").addEventListener("click", function() {
        ...
        if (guideActive) document.addEventListener('mousemove', moveReadingGuide);
        else document.removeEventListener('mousemove', moveReadingGuide);
    });
