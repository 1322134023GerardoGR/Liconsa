...
// Agregar nombre completo del beneficiario
        $pdf->Text($x + 5, $y + 38, 'Nombre: '.'$nombreCompleto');

// Agregar cantidad de beneficiarios
        $pdf->Text($x + 5, $y + 48, 'Cant de Beneficiarios: '.'$cant_beneficiarios');

        $pdf->Text($x + 5, $y + 58, 'Direccion: '.'$direccion');
...
// Agregar texto informativo o cualquier otro detalle
        $fecha_vencimiento = new DateTime('2023-09-15'); // Crea un objeto DateTime
        $intervalo = new DateInterval('P1M'); // Crea un intervalo de 1 mes
